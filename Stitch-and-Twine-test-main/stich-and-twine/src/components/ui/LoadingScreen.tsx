      ...
      {show && (
        ...
        >
          ...
          <div className="relative flex flex-col items-center gap-8">
            ...
            >
              <h1 className="font-playfair italic text-3xl md:text-5xl tracking-[0.25em] text-[#2E2E2E] flex gap-0">
            ...
            <motion.p
              ...
              className="font-inter text-xs tracking-[0.3em] uppercase text-[#C4A484]"
            >
              Handmade with love
            </motion.p>
