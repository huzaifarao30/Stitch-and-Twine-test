        ...
        <div className="category-card group aspect-[3/4] rounded-2xl overflow-hidden">
          ...
          <div className="category-overlay">
            <div className="text-center px-4">
              ...
              <div className="mt-4 inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-white/50 text-white text-xs hover:bg-white/20 transition-colors">
