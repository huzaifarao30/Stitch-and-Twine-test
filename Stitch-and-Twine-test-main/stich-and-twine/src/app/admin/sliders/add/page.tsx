...
import { addSlider } from "@/lib/adminStore";
...
export default function AddSliderPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Convert uploaded file to data URL so it survives localStorage
    let imageUrl = "/products/sliders/sliders (1).png";
    if (form.image) {
  ...
  return (
    <div className="p-6 md:p-8 max-w-2xl">
      ...
      <div className="flex items-center gap-3 mb-7">
        ...
        <div>
          <h1 className="font-playfair text-2xl text-[#2E2E2E]">Add Slide</h1>
          <p className="text-xs text-[#9B8B7A] mt-0.5">Create a new hero section slide</p>
        </div>
      </div>
          ...
          <div className="border-2 border-dashed border-[#EDE6DA] rounded-xl p-6 text-center hover:border-[#C4A484] transition-colors">
            {imagePreview ? (
              <div className="relative inline-block">
                ...
                <img src={imagePreview} alt="Preview" className="h-40 w-full max-w-md rounded-xl object-cover mx-auto" />
                <button
                  type="button"
                  onClick={clearImage}
