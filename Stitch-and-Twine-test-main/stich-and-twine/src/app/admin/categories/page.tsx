...
import { getAllCategories, getAllProducts, deleteCategory } from "@/lib/adminStore";
  ...
  return (
    <div className="p-6 md:p-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="font-playfair text-3xl text-[#2E2E2E]">Categories</h1>
          <p className="text-[#6B6B6B] text-sm mt-1">{categories.length} categories</p>
        </div>
      ...
      {categories.length === 0 ? (
        <div className="py-20 text-center">
          ...
          <p className="text-[#9B8B7A]">No categories yet. Add one!</p>
        </div>
      ) : (
          ...
          <AnimatePresence>
            {categories.map((cat) => (
              ...
              >
                ...
                <div className="p-4">
                  <p className="text-xs text-[#6B6B6B] line-clamp-2 mb-3">{cat.description}</p>
                  <div className="flex items-center justify-between">
                    <code className="text-xs text-[#9B8B7A] bg-[#F6F2EA] px-2 py-1 rounded">{cat.slug}</code>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-playfair text-lg text-[#2E2E2E]">Delete Category?</h3>
                <button onClick={() => setConfirmDelete(null)} className="text-[#9B8B7A] hover:text-[#2E2E2E]">
                  <X size={18} />
                </button>
              </div>
              <p className="text-sm text-[#6B6B6B] mb-5">This category will be removed. Products inside it won't be deleted.</p>
